...
function _createComparisonValue(
    ...
    population: number, maxPopulation: number, opts: MultiGeneratorOptions): number {
...
function _findColorVariation(palette: Palette, swatches: Array<Swatch>, maxPopulation: number,
    ...
    opts: MultiGeneratorOptions): Array<Swatch> {
...
function _generateEmptySwatches(palette: Palette, maxPopulation: number, opts: MultiGeneratorOptions): void {
